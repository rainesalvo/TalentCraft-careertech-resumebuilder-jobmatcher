  ...
  return (
    <div className="bg-gradient-to-b from-blue-50 to-white min-h-screen py-10">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            <div>
              ...
              <p className="text-blue-100">
                Create a polished, professional resume in minutes
              </p>
            </div>
            <Link
              to="/home"
              className="flex items-center gap-2 text-white hover:text-gray-200 font-medium group transition-all"
            >
          ...
          {activeTab === "personal" && (
            <div className="space-y-4">
              ...
              <p className="text-gray-600 text-sm">
                Tell us about yourself so employers can contact you.
              </p>
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">
                  Keep your summary concise and impactful - 3-5 sentences is
                  ideal.
                </p>
              </div>
            </div>
          ...
          {activeTab === "skills" && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Categorize your skills by type for better organization.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleSkillChange("librariesFrameworks", e.target.value)
                    }
                    className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                  <p className="mt-1 text-xs text-gray-500">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleSkillChange("microservices", e.target.value)
                    }
                    className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                  <p className="mt-1 text-xs text-gray-500">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleSkillChange("toolsPlatforms", e.target.value)
                    }
                    className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                  <p className="mt-1 text-xs text-gray-500">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleSkillChange("designPrototyping", e.target.value)
                    }
                    className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                  <p className="mt-1 text-xs text-gray-500">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleSkillChange("concepts", e.target.value)
                    }
                    className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                  <p className="mt-1 text-xs text-gray-500">
            ...
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Highlight your most significant projects with detailed
                    descriptions.
                  </p>
                </div>
                <button
                      ...
                      >
                        ...
                        {project.points.length > 1 && (
                          <button
                            type="button"
                            onClick={() =>
                              removePoint("projects", projectIndex, pointIndex)
                            }
                            className="text-red-500 hover:text-red-700"
                          >
                            <svg
            ...
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Include smaller projects or side projects with brief
                    descriptions.
                  </p>
                </div>
                <button
            ...
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Add your professional experience, starting with the most
                    recent.
                  </p>
                </div>
                <button
                      ...
                      >
                        ...
                        {exp.points.length > 1 && (
                          <button
                            type="button"
                            onClick={() =>
                              removePoint("experience", expIndex, pointIndex)
                            }
                            className="text-red-500 hover:text-red-700"
                          >
                            <svg
      ...
      <div className="max-w-4xl mx-auto text-center mt-8 text-gray-500 text-sm">
        &copy; 2025 TalentCraft. All rights reserved.
      </div>
    </div>
  );
};
