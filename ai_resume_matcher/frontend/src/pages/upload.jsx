...
function ResumeUpload() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (!token) {
        throw new Error(
          "You are not logged in. Please log in to upload a resume."
        );
      }
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 animate-fade-in">
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-10 bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl shadow-blue-100/50 p-8 border border-white/20 mb-8 hover:shadow-2xl hover:shadow-blue-200/30 transition-all duration-500 transform">
            <div>
              <h1 className="text-4xl font-bold text-indigo-600 bg-clip-text">
                Resume Parser
              </h1>
              <p className="mt-1 text-slate-600 text-md font-medium">
          ...
          {/* Simple Footer */}
          <footer className="mt-20 text-center py-3 border-t border-slate-200">
